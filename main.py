...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'zuberm137@gmail.com' ")
...
message3 = tk.Label(window, text="Attendance Management System using Face Recognition " ,fg="white",bg="#2d420a" ,width=55 ,height=1,font=('comic', 29, ' bold '))
